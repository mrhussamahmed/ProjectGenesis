...
- Public launch readiness and adoption packaging is in progress on
  `codex/public-launch-assets`. This work is additive and creates launch,
  demo, example, issue-template, token-efficiency, release-note, seed-issue, and
  roadmap proposal assets without changing product behavior or governance
  mechanics.
...
then perform manual GitHub launch items after the reviewed branch is merged.
