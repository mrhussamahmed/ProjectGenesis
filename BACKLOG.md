...
source: Initial bootstrap scaffold, public repository publication request, ProjectGenesis PR merge, README positioning/tooling prerequisite update, BOOT-017 merge, SPEC-BOOT-003 proposal, SPEC-BOOT-003 review fixes, SPEC-BOOT-003 approval, and BOOT-018 merge
...
| BOOT-019 | Define operation profile policy | After `SPEC-BOOT-003` is approved or activated, update governance-facing docs with approved operation profiles, risk mapping, branch rules, validation, and review requirements. | P1 | medium | high | BOOT-018 | blocked pending separate work authorization | sequential | Documentation Curator |
