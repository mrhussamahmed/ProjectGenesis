...
source: Initial bootstrap scaffold, SPEC-BOOT-003 proposal, SPEC-BOOT-003 review fixes, SPEC-BOOT-003 approval, BOOT-018 merge, and BOOT-019 through BOOT-024 implementation
...
| SPEC-BOOT-003 | Adaptive Governance Routing | `SPECS/SPEC-BOOT-003-adaptive-governance-routing.md` | approved | v1.0 | AI Bootstrap Maintainers | BOOT-018 through BOOT-024 | none | none | Approved spec; BOOT-019 through BOOT-024 mechanics are implemented on `codex/boot-019-024-adaptive-governance` and pending fresh-context review. |
