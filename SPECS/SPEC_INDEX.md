...
source: Initial bootstrap scaffold, SPEC-BOOT-003 proposal, SPEC-BOOT-003 review fixes, SPEC-BOOT-003 approval, and BOOT-018 merge
...
| SPEC-BOOT-003 | Adaptive Governance Routing | `SPECS/SPEC-BOOT-003-adaptive-governance-routing.md` | approved | v1.0 | AI Bootstrap Maintainers | BOOT-018 through BOOT-024 | none | none | Approved policy-only spec merged through PR #3; follow-up mechanics require separate reviewed slices. |
