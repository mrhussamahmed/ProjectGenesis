...
source: User request, initial scaffold, final adversarial review, stale status fix, narrow re-review, command shortcut setup, public repository publication request, GitHub branch protection setup, ProjectGenesis PR merge, README positioning/tooling prerequisite update, BOOT-017 review, BOOT-017 validation, BOOT-017 PR creation, BOOT-017 merge, SPEC-BOOT-003 proposal, SPEC-BOOT-003 review fixes, and SPEC-BOOT-003 approval
...
|-------------|---------|--------------|----------|-------|---------------|----------------|
| AGR-FR-001: Operation profiles mapped to risk, branch, validation, review, and durable evidence | SPEC-BOOT-003 | BOOT-018, BOOT-019 | `RISK_MODEL.md`; `PR_REVIEW_POLICY.md`; `BRANCH_AND_WORKTREE_GUIDE.md`; user instruction | `bash SCRIPTS/validate-bootstrap.sh`; `git diff --check`; fresh-context adversarial re-review | `REVIEWS/REVIEW-2026-05-13-spec-boot-003-adaptive-governance.md` | approved |
| AGR-FR-002: Durable pre-change classification before target edits | SPEC-BOOT-003 | BOOT-018, BOOT-021 | `memory/ai/SHARED_AGENT_RULES.md`; `AI_PROJECT_BOOTSTRAP.md`; `GOVERNANCE.md`; `AI_HANDOFF.md` pre-change classification for this slice | `bash SCRIPTS/validate-bootstrap.sh`; `git diff --check`; fresh-context adversarial re-review | `REVIEWS/REVIEW-2026-05-13-spec-boot-003-adaptive-governance.md` | approved |
| AGR-FR-003: Final durable evidence envelope after validation | SPEC-BOOT-003 | BOOT-018, BOOT-021 | `memory/ai/SHARED_AGENT_RULES.md`; `AI_PROJECT_BOOTSTRAP.md`; `GOVERNANCE.md`; final handoff update for this slice | `bash SCRIPTS/validate-bootstrap.sh`; `git diff --check`; fresh-context adversarial re-review | `REVIEWS/REVIEW-2026-05-13-spec-boot-003-adaptive-governance.md` | approved |
| AGR-FR-004: Protected artifacts by registry authority and explicit paths | SPEC-BOOT-003 | BOOT-018, BOOT-020 | `ARTIFACT_REGISTRY.md` authority model; `GOVERNANCE.md` artifact lifecycle | fresh-context adversarial re-review | `REVIEWS/REVIEW-2026-05-13-spec-boot-003-adaptive-governance.md` | approved |
| AGR-FR-005: Deterministic escalation precedence | SPEC-BOOT-003 | BOOT-018, BOOT-019 | `RISK_MODEL.md`; `PR_REVIEW_POLICY.md`; `BRANCH_AND_WORKTREE_GUIDE.md`; user instruction | fresh-context adversarial re-review | `REVIEWS/REVIEW-2026-05-13-spec-boot-003-adaptive-governance.md` | approved |
| AGR-FR-006: Dirty worktree edits blocked unless inspected and isolated | SPEC-BOOT-003 | BOOT-018, BOOT-019 | `BRANCH_AND_WORKTREE_GUIDE.md`; `PR_REVIEW_POLICY.md`; `git status --short --branch` | `git status --short --branch`; fresh-context adversarial re-review | `REVIEWS/REVIEW-2026-05-13-spec-boot-003-adaptive-governance.md` | approved |
| AGR-FR-007: Exact not-impacted rules for traceability, registry, state, handoff, test results, and worklog | SPEC-BOOT-003 | BOOT-018, BOOT-020, BOOT-022 | `TRACEABILITY_MATRIX.md`; `ARTIFACT_REGISTRY.md`; `memory/ai/SHARED_AGENT_RULES.md` | fresh-context adversarial re-review | `REVIEWS/REVIEW-2026-05-13-spec-boot-003-adaptive-governance.md` | approved |
| AGR-FR-008: Handoff and current-state compression cannot lose active operational facts | SPEC-BOOT-003 | BOOT-018, BOOT-022 | `AI_HANDOFF.md`; `CURRENT_STATE.md`; `memory/ai/SHARED_AGENT_RULES.md` | fresh-context adversarial re-review | `REVIEWS/REVIEW-2026-05-13-spec-boot-003-adaptive-governance.md` | approved |
| AGR-FR-009: Claim evidence check for public, setup, tooling, and external-integration claims | SPEC-BOOT-003 | BOOT-018, BOOT-021 | `GOVERNANCE.md`; `BACKLOG.md`; `TRACEABILITY_MATRIX.md` | fresh-context adversarial re-review | `REVIEWS/REVIEW-2026-05-13-spec-boot-003-adaptive-governance.md` | approved |
| AGR-FR-010: CI/manual validation boundaries are explicit | SPEC-BOOT-003 | BOOT-018, BOOT-021, BOOT-023 | `CI_CD_GUIDE.md`; `TEST_RESULTS.md`; `.github/workflows/bootstrap-validation.yml` | fresh-context adversarial re-review | `REVIEWS/REVIEW-2026-05-13-spec-boot-003-adaptive-governance.md` | approved |
| AGR-FR-011: First slice remains policy-only | SPEC-BOOT-003 | BOOT-018 | `SPEC-BOOT-003` first-slice scope; `git diff --name-only`; review package | `git diff --name-only`; fresh-context adversarial re-review | `REVIEWS/REVIEW-2026-05-13-spec-boot-003-adaptive-governance.md` | approved |
