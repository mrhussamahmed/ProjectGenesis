...
source: User request, initial scaffold, final adversarial review, stale status fix, narrow re-review, command shortcut setup, public repository publication request, GitHub branch protection setup, ProjectGenesis PR merge, README positioning/tooling prerequisite update, BOOT-017 review, BOOT-017 validation, BOOT-017 PR creation, BOOT-017 merge, SPEC-BOOT-003 proposal, SPEC-BOOT-003 review fixes, SPEC-BOOT-003 approval, BOOT-018 merge, and BOOT-019 through BOOT-024 implementation
...
|-------------|---------|--------------|----------|-------|---------------|----------------|
| AGR-FR-001: Operation profiles mapped to risk, branch, validation, review, and durable evidence | SPEC-BOOT-003 | BOOT-018, BOOT-019 | `OPERATION_ROUTING.md`; `RISK_MODEL.md`; `PR_REVIEW_POLICY.md`; `BRANCH_AND_WORKTREE_GUIDE.md` | `bash SCRIPTS/validate-bootstrap.sh`; `git diff --check`; pending fresh-context adversarial review | `REVIEWS/REVIEW-2026-05-14-adaptive-governance-implementation.md` pending | implemented pending review |
| AGR-FR-002: Durable pre-change classification before target edits | SPEC-BOOT-003 | BOOT-018, BOOT-021 | `memory/ai/SHARED_AGENT_RULES.md`; `AI_PROJECT_BOOTSTRAP.md`; `GOVERNANCE.md`; `AI_HANDOFF.md` BOOT-019-024 pre-change classification | `bash SCRIPTS/validate-bootstrap.sh`; `git diff --check`; pending fresh-context adversarial review | `REVIEWS/REVIEW-2026-05-14-adaptive-governance-implementation.md` pending | implemented pending review |
| AGR-FR-003: Final durable evidence envelope after validation | SPEC-BOOT-003 | BOOT-018, BOOT-021 | `OPERATION_ROUTING.md`; `AI_HANDOFF.md` BOOT-019-024 final evidence envelope; `TEST_RESULTS.md`; review package | `bash SCRIPTS/validate-bootstrap.sh`; `bash SCRIPTS/validate-bootstrap-red-checks.sh`; pending fresh-context adversarial review | `REVIEWS/REVIEW-2026-05-14-adaptive-governance-implementation.md` pending | implemented pending review |
| AGR-FR-004: Protected artifacts by registry authority and explicit paths | SPEC-BOOT-003 | BOOT-018, BOOT-020 | `OPERATION_ROUTING.md`; `ARTIFACT_REGISTRY.md`; `GOVERNANCE.md` | `bash SCRIPTS/validate-bootstrap.sh`; pending fresh-context adversarial review | `REVIEWS/REVIEW-2026-05-14-adaptive-governance-implementation.md` pending | implemented pending review |
| AGR-FR-005: Deterministic escalation precedence | SPEC-BOOT-003 | BOOT-018, BOOT-019 | `OPERATION_ROUTING.md`; `RISK_MODEL.md`; `PR_REVIEW_POLICY.md`; `BRANCH_AND_WORKTREE_GUIDE.md` | `bash SCRIPTS/validate-bootstrap.sh`; pending fresh-context adversarial review | `REVIEWS/REVIEW-2026-05-14-adaptive-governance-implementation.md` pending | implemented pending review |
| AGR-FR-006: Dirty worktree edits blocked unless inspected and isolated | SPEC-BOOT-003 | BOOT-018, BOOT-019 | `OPERATION_ROUTING.md`; `BRANCH_AND_WORKTREE_GUIDE.md`; `PR_REVIEW_POLICY.md`; `git status --short --branch` | `git status --short --branch`; pending fresh-context adversarial review | `REVIEWS/REVIEW-2026-05-14-adaptive-governance-implementation.md` pending | implemented pending review |
| AGR-FR-007: Exact not-impacted rules for traceability, registry, state, handoff, test results, and worklog | SPEC-BOOT-003 | BOOT-018, BOOT-020, BOOT-022 | `OPERATION_ROUTING.md`; `TRACEABILITY_MATRIX.md`; `ARTIFACT_REGISTRY.md`; `memory/ai/SHARED_AGENT_RULES.md` | `bash SCRIPTS/validate-bootstrap.sh`; pending fresh-context adversarial review | `REVIEWS/REVIEW-2026-05-14-adaptive-governance-implementation.md` pending | implemented pending review |
| AGR-FR-008: Handoff and current-state compression cannot lose active operational facts | SPEC-BOOT-003 | BOOT-018, BOOT-022 | `OPERATION_ROUTING.md`; `AI_HANDOFF.md`; `CURRENT_STATE.md`; `CONTEXT_PACKS/resume.md` | pending fresh-context adversarial review | `REVIEWS/REVIEW-2026-05-14-adaptive-governance-implementation.md` pending | implemented pending review |
| AGR-FR-009: Claim evidence check for public, setup, tooling, and external-integration claims | SPEC-BOOT-003 | BOOT-018, BOOT-021 | `OPERATION_ROUTING.md`; `GOVERNANCE.md`; `PR_REVIEW_POLICY.md` | pending fresh-context adversarial review | `REVIEWS/REVIEW-2026-05-14-adaptive-governance-implementation.md` pending | implemented pending review |
| AGR-FR-010: CI/manual validation boundaries are explicit | SPEC-BOOT-003 | BOOT-018, BOOT-021, BOOT-023 | `OPERATION_ROUTING.md`; `CI_CD_GUIDE.md`; `TEST_RESULTS.md`; `.github/workflows/bootstrap-validation.yml` | `bash SCRIPTS/validate-bootstrap.sh`; `bash SCRIPTS/validate-bootstrap-red-checks.sh`; shell syntax checks; pending CI | `REVIEWS/REVIEW-2026-05-14-adaptive-governance-implementation.md` pending | implemented pending review and CI |
