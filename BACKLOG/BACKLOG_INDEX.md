...
source: Initial bootstrap scaffold, Phase 1 execution planning, PR #6 merge/post-merge source-of-truth cleanup, BOOT-030 in-review status, PR #7 BOOT-030 merge/post-merge source-of-truth cleanup, and BOOT-031 scaffold extraction tool implementation
...
| BOOT-031 | Scaffold Extraction Tool | `BACKLOG/BOOT-031-scaffold-extract-tool.md` | in-review | P0 | medium | high | SPEC-BOOT-002, SPEC-BOOT-003 | sequential |
| BOOT-032 | Seeded-Defect Benchmark | `BACKLOG/BOOT-032-seeded-defect-benchmark.md` | queued after BOOT-031; research-only prep allowed if isolated | P0 | medium | high | SPEC-BOOT-003 | candidate research only |
