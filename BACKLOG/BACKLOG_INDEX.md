...
| BOOT-RESEARCH-001 | Research Orchestration Layer | `BACKLOG/BOOT-RESEARCH-001-research-orchestration.md` | done | P1 | high | medium | none; recurring bootstrap-governance exception in `PR_MERGE_POLICY.md` | not-allowed |
