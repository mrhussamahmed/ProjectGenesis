...
source: Initial bootstrap scaffold, Phase 1 execution planning, and PR #6 merge/post-merge source-of-truth cleanup
...
| BOOT-030 | Scaffold Extraction Checklist | `BACKLOG/BOOT-030-scaffold-extract-checklist.md` | ready | P0 | medium | high | SPEC-BOOT-002, SPEC-BOOT-003 | sequential |
