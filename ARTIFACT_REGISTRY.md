...
| ART-REG-001 | registry | Artifact Registry | `ARTIFACT_REGISTRY.md` | authoritative | v3.5 | scaffold, shared role update, review fix, SPEC-BOOT-002 implementation, merge, final adversarial review, stale status fix, narrow re-review, command shortcut setup, public repository publication request, GitHub branch protection setup, ProjectGenesis PR merge, post-merge CI cleanup, checkout action maintenance, final maintenance validation, README positioning/tooling prerequisite update, BOOT-017 review, BOOT-017 validation, and BOOT-017 PR creation | SPEC-BOOT-002 | none | true | Current artifact inventory. |
| ART-TRACE-001 | traceability | Traceability Matrix | `TRACEABILITY_MATRIX.md` | authoritative | v2.10 | scaffold, shared role update, review fix, SPEC-BOOT-002 final adversarial review, stale status fix, narrow re-review, command shortcut setup, public repository publication request, GitHub branch protection setup, ProjectGenesis PR merge, README positioning/tooling prerequisite update, BOOT-017 review, BOOT-017 validation, and BOOT-017 PR creation | SPEC-BOOT-002 | none | true | Requirement-to-evidence map. |
...
| ART-STATE-002 | shared-state | Current State | `CURRENT_STATE.md` | active | v3.3 | scaffold, shared role update, review fix, SPEC-BOOT-002 merge, final adversarial review, stale status fix, narrow re-review, command shortcut setup, public repository publication request, GitHub branch protection setup, ProjectGenesis PR merge, README positioning/tooling prerequisite update, BOOT-017 review, BOOT-017 validation, and BOOT-017 PR creation | SPEC-BOOT-002 | none | false | Current operational view. |
| ART-STATE-003 | shared-state | AI Handoff | `AI_HANDOFF.md` | active | v3.4 | scaffold, shared role update, review fix, SPEC-BOOT-002 merge, final adversarial review, stale status fix, narrow re-review, command shortcut setup, public repository publication request, GitHub branch protection setup, ProjectGenesis PR merge, checkout action maintenance, README positioning/tooling prerequisite update, BOOT-017 review, BOOT-017 validation, and BOOT-017 PR creation | SPEC-BOOT-002 | none | false | Agent transition state. |
...
| ART-TEST-003 | test-results | Test Results | `TEST_RESULTS.md` | active | v1.25 | scaffold, shared role update, review fix, SPEC-BOOT-002 merge, final adversarial review, stale status fix, narrow re-review, command shortcut setup, public repository publication request, GitHub branch protection setup, ProjectGenesis PR merge, post-merge CI cleanup, checkout action maintenance, final maintenance validation, README positioning/tooling prerequisite update, BOOT-017 review, BOOT-017 validation, and BOOT-017 PR creation | SPEC-BOOT-002 | none | false | Validation history. |
...
| ART-WORKLOG-INDEX | worklog | Worklog Index | `WORKLOG/WORKLOG_INDEX.md` | active | v3.4 | scaffold, shared role update, review fix, SPEC-BOOT-002 merge, final adversarial review, stale status fix, narrow re-review, command shortcut setup, public repository publication request, GitHub branch protection setup, ProjectGenesis PR merge, post-merge CI cleanup, checkout action maintenance, final maintenance validation, README positioning/tooling prerequisite update, BOOT-017 review, BOOT-017 validation, and BOOT-017 PR creation | SPEC-BOOT-002 | none | false | Session history. |
