...
source: Initial bootstrap scaffold, SPEC-BOOT-002 implementation and merge, final adversarial review, stale status fix, narrow re-review, start requirement breakdown command shortcut, public repository publication request, GitHub branch protection setup, and ProjectGenesis PR merge
...
| ART-README | public-readme | ProjectGenesis README | `README.md` | authoritative | v1.0 | public repository publication request | SPEC-BOOT-002 | none | true | Public overview, usage guide, requirements, repository controls, limitations, and license summary. |
...
| ART-REG-001 | registry | Artifact Registry | `ARTIFACT_REGISTRY.md` | authoritative | v2.8 | scaffold, shared role update, review fix, SPEC-BOOT-002 implementation, merge, final adversarial review, stale status fix, narrow re-review, command shortcut setup, public repository publication request, GitHub branch protection setup, and ProjectGenesis PR merge | SPEC-BOOT-002 | none | true | Current artifact inventory. |
...
| ART-TEST-003 | test-results | Test Results | `TEST_RESULTS.md` | active | v1.18 | scaffold, shared role update, review fix, SPEC-BOOT-002 merge, final adversarial review, stale status fix, narrow re-review, command shortcut setup, public repository publication request, GitHub branch protection setup, and ProjectGenesis PR merge | SPEC-BOOT-002 | none | false | Validation history. |
...
| ART-REVIEW-INDEX | review-index | Review Index | `REVIEWS/REVIEW_INDEX.md` | active | v2.0 | scaffold, shared role review fixes, scaffold plan review, SPEC-BOOT-002 reviews, final adversarial review, narrow re-review, command shortcut plan review, and public repository publication request | SPEC-BOOT-002 | none | true | Review inventory. |
...
| ART-WORKLOG-INDEX | worklog | Worklog Index | `WORKLOG/WORKLOG_INDEX.md` | active | v2.6 | scaffold, shared role update, review fix, SPEC-BOOT-002 merge, final adversarial review, stale status fix, narrow re-review, command shortcut setup, public repository publication request, GitHub branch protection setup, and ProjectGenesis PR merge | SPEC-BOOT-002 | none | false | Session history. |
